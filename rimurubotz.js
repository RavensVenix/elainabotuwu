...
mentions: [sender],
sections: [{ rows: [
{title: "Instagram : " + ig, rowId: prefix + "xx"},
{title: "Facebook : " + fb, rowId: prefix + "xx"},
{title: "TikTok : " + tt, rowId: prefix + "xx"},
{title: "WhatsApp : " + owner, rowId: prefix + "xx"}
]}]},{quoted:nay1})
...
if (budy == "Assalamualaikum" || budy == "assalamualaikum" || budy == "salamualaikum" || budy == "aas.." || budy == "Ass.." || budy == "Assalamualaikun") {
...
if (budy == "lagi apa?" || budy == "LAGI APA?" || budy == "Lagi Apa?" || budy == "gi apa?" || budy == "agyy apa?" || budy == "agy apa?") {
reply(`school(); home(); eat(); games(); sleep(); repeat();`)
}
